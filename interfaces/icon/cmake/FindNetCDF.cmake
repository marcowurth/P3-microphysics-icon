...
Adapted for Horeka libraries from comin/cmake/Modules/FindNetCDF.cmake
...
execute_process(COMMAND ${NF_CONFIG_BIN}/nf-config --includedir
  OUTPUT_VARIABLE NC_CONFIG_Fortran_INCLUDE_DIR
  OUTPUT_STRIP_TRAILING_WHITESPACE)

find_path(NetCDF_Fortran_INCLUDE_DIR
NAMES netcdf.mod
HINTS ${NC_CONFIG_Fortran_INCLUDE_DIR}
DOC "NetCDF Fortran include directory"
)
...
execute_process(COMMAND ${NF_CONFIG_BIN}/nf-config --flibs
