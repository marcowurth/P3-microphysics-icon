...
!! JM_20260407 >> defining new comin handle and pointer for 2moment ice-phase, 2mom ice-ice collision, 2mom ice-liquid and 3mom ice-phase diagnostics
  PUBLIC :: t_p3_ice_diag_2mom_handle, t_p3_ice_diag_2mom_3dptr
  PUBLIC :: t_p3_ice_diag_2mom_coll_handle, t_p3_ice_diag_2mom_coll_3dptr
  PUBLIC :: t_p3_ice_diag_2mom_liqfrac_handle, t_p3_ice_diag_2mom_liqfrac_3dptr
  PUBLIC :: t_p3_ice_diag_3mom_handle, t_p3_ice_diag_3mom_3dptr
!! << JM_20260407
...
!! JM_20260407 >> defining new comin handle and pointer for ice-phase diagnostics (need to be adjusted here when adding more diagnostics)
  ...
  END type t_p3_ice_diag_2mom_3dptr

  TYPE :: t_p3_ice_diag_2mom_coll_handle
    TYPE(t_comin_var_handle)            :: d_qicol_
  END type t_p3_ice_diag_2mom_coll_handle

  TYPE :: t_p3_ice_diag_2mom_coll_3dptr
    REAL(wp), POINTER, DIMENSION(:,:,:) :: d_qicol_
  CONTAINS
    PROCEDURE :: nullify => nullify_p3_ice_diag_2mom_coll_3dptr
  END type t_p3_ice_diag_2mom_coll_3dptr
...
!! JM_20260407 >> cleanup ice-phase diagnostics (need to be adjusted here when adding more diagnostics)
  ...
  SUBROUTINE nullify_p3_ice_diag_2mom_coll_3dptr(this)
   CLASS(t_p3_ice_diag_2mom_coll_3dptr), INTENT(inout) :: this
   NULLIFY(this%d_qicol_)
  END SUBROUTINE nullify_p3_ice_diag_2mom_coll_3dptr
